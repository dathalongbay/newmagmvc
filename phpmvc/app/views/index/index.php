...
<head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="<?php echo URL_ASSETS ?>css/bootstrap.min.css"/>

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="<?php echo URL_ASSETS ?>css/font-awesome.min.css">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="<?php echo URL_ASSETS ?>css/style.css"/>
...
<script src="<?php echo URL_ASSETS ?>js/bootstrap.min.js"></script>
